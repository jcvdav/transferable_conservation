...
# Source directory -------------------------------------------------------------
source_dir <- here("results", "processed_data", "supply_curves", "with_mpas_mc0")


# Load data --------------------------------------------------------------------
eez_cb <- readRDS(file = here(source_dir, "global_eez_supply_curves_with_mpas_mc0.rds"))
eez_h_sum_cb  <- readRDS(file = here(source_dir, "global_supply_curve_with_mpas_mc0.rds"))

hem_eez_cb <- readRDS(file = here(source_dir, "hemisphere_eez_supply_curves_with_mpas_mc0.rds"))
hem_h_sum <- readRDS(file = here(source_dir, "hemisphere_supply_curves_with_mpas_mc0.rds"))

rlm_eez_cb <- readRDS(file = here(source_dir, "realm_eez_supply_curves_with_mpas_mc0.rds"))
rlm_h_sum <- readRDS(file = here(source_dir, "realm_supply_curves_with_mpas_mc0.rds"))

pro_eez_cb <- readRDS(file = here(source_dir, "province_eez_supply_curves_with_mpas_mc0.rds"))
pro_h_sum <- readRDS(file = here(source_dir, "province_supply_curves_with_mpas_mc0.rds"))

eco_eez_cb <- readRDS(file = here(source_dir, "ecoregion_eez_supply_curves_with_mpas_mc0.rds"))
eco_h_sum <- readRDS(file = here(source_dir, "ecoregion_supply_curves_with_mpas_mc0.rds"))
...
saveRDS(
  ...
  file = here("results", "output_data", "gains_from_trade_bubbles_mc0.rds")
)
